                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control " id="prenom" placeholder="First name" name="prenom"  pattern="[A-Za-z]+" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="nom">Last name</label>
                                                    <input type="text" class="form-control " id="nom" placeholder="Last name" name="nom" value=""  pattern="[A-Za-z]+" required>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control " name="cpassword" id="cpassword" placeholder="Confirm Password" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="col-md-12">
